...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Transformers-HuggingFace-FFA000?style=flat-square&logo=huggingface&logoColor=white" alt="Transformers" />
...
* **📂 imdb_sentiment_analysis**
    * 📂 `.github/workflows` — *Automated code quality check configurations (ci-cd.yml)*
    * 📂 `data/raw` — *Raw unstructured IMDB dataset dumps*
    * 📂 `data/processed` — *Fully structured tokens and embedded arrays*
    * 📂 `models` — *Serialized lightweight statistical weights & neural maps*
    * 📂 `notebooks` — *imdb_sentiment_analysis.ipynb (Main analytical core)*
    * 📂 `scripts` — *Modular Python text cleaning and evaluation functions*
